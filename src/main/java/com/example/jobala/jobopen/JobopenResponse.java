...
public class JobopenResponse {
    ...
    public static class DTO {
        ...
        public DTO(Integer id, Integer userId, String compname, String jobopenTitle, String content, String career, String edu, String hopeJob, String compLocation, String jobType, String salary, java.sql.Date endTime, Integer role, int count) {
            this.id = id;
            this.userId = userId;
