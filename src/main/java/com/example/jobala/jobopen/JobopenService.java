...
public class JobopenService {
    ...
    // 공고보기
    public JobopenResponse.DetailDTO jobopenFindById(Integer jobopenId, User sessionUser) {
        ...
        // isScrap
        Optional<Scrap> scrap = scrapJPARepository.findCompScrapByResumeIdAndUserId(jobopenId, sessionUser.getId());
        JobopenResponse.DetailDTO respDTO = new JobopenResponse.DetailDTO(jobopenId, sessionUser);
