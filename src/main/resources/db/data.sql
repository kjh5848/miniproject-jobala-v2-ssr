...
VALUES (12, '소프트웨어 개발자 채용', '신입', '고등학교 졸업', '백엔드', '서울', '정규직', '협의', '2024-12-31',
       ...
       (13, '데이터 분석가 채용', '경력', '대학교 졸업', '백엔드', '부산', '정규직', '5000만원 이상', '2024-11-30', '[Java, HTML, MySQL]', 1,
        now()),
       ...
       (20, 'UI/UX 디자이너 채용', '경력', '고등학교 졸업', '프론트엔드', '부산', '계약직', '3000만원 이상', '2024-06-22', '[Java, HTML, jQuery]',
        1,
        now());
