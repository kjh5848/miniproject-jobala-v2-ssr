...
--댓글 더미
Insert Into reply_tb(id, comment, board_id, user_id, created_at)
values (1, '꼰대임?', 1, 2, now()),       --cos2이 1번 게시물에 댓글을 작성했다.
       (2, '넌 몇년차인데?ㅋㅋ', 1, 3, now()), --cos3가 1번 게시물에 댓글을 작성했다.
       (3, '관심 받고 싶니?', 2, 1, now()),  --cos1이 2번 게시물에 댓글을 작성했다.
       (4, '너가 주면 난 내 전재산 준다', 2, 3, now()), --cos3가 2번 게시물에 댓글을 작성했다.
       (5, '뭐지', 3, 2, now()); --cos3가 3번 게시물에 댓글을 작성했다.
