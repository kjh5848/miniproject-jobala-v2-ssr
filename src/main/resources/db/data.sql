...
values (1, '박선규', '이력서 제목1-1', '프론트엔드', '신입', '정보처리기사', '1번 유저의 자기소개서 1..... ..... ..... .....', '대학교 졸업', now());
insert into resume_tb(user_id, name, resume_title, hope_job, career, license, content, edu, created_at)
values (1, '박선규','이력서 제목1-2', '백엔드', '신입', ' 정보처리기사', '1번 유저의 자기소개서 2..... ..... ..... .....', '대학교 졸업', now());
insert into resume_tb(user_id, name, resume_title, hope_job, career, license, content, edu, created_at)
values (2, '서강준','이력서 제목2-1', '프론트엔드', '신입', 'SQLD', '2번 유저의 자기소개서 1..... ..... ..... .....', '고등학교 졸업', now());
insert into resume_tb(user_id, name, resume_title, hope_job, career, license, content, edu, created_at)
values (2, '서강준','이력서 제목2-2', '백엔드', '신입', 'SQLD', '2번 유저의 자기소개서 2..... ..... ..... .....', '고등학교 졸업', now());
