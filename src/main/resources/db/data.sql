...
--        ('김흥국', 'gook', 'gook@nate.com', '1234', '부산광역시 해운대구', '1997-03-25', '01012345678', 0, now());
--        ('강호동', 'dong', 'dong@nate.com', '1234', '부산광역시 기장군', '1995-04-17', '01012345678', 0, now());
--        ('유재석', 'seok', 'seok@nate.com', '1234', '부산광역시 ', '2000-04-25', '01012345678', 0, now());
--        ('지석진', 'jin', 'jin@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, now());
--        ('송지효', 'ji', 'ji@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, now());
--        ('김종국', 'jong', 'jong@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, now());
--        ('양세찬', 'chan', 'chan@nate.com', '1234', '부산광역시 금정구', '2000-04-25', '01012345678', 0, now());
...
VALUES (3, '네이버', '소프트웨어 개발자 채용', '네이버에서 함께 일해보세요!', '신입', '고등학교 졸업', '백엔드', '서울', '정규직', '협의', '2024-12-31', now(), 1),
       (3, '네이버', '데이터 분석가 채용', '카카오에서 데이터로 세상을 바꿔보세요!', '경력', '대학교 졸업', '백엔드', '서울', '정규직', '5,000만원 이상', '2024-11-30',
        now(), 1),
       (4, '카카오', 'UI/UX 디자이너 채용', '라인에서 사용자 경험을 디자인하세요!', '신입', '고등학교 졸업', '프론트엔드', '서울', '정규직', '3,000만원 이상', '2024-10-31',
        now(), 1),
       (5, '쿠팡', '마케팅 전문가 채용', '쿠팡에서 함께 성장하세요!', '경력', '대학교 졸업', '백엔드', '서울', '정규직', '협의', '2024-09-30', now(), 1),
       (5, '쿠팡', '운영 지원 인력 채용', '배달의민족의 성장을 함께 이끌어가세요!', '경력', '고등학교 졸업', '프론트엔드', '서울', '계약직', '협의', '2024-08-31', now(),
        1);
