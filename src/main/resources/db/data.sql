...
VALUES (1, '쿠팡', '소프트웨어 개발자 채용', '네이버에서 함께 일해보세요!', '신입', '고등학교 졸업', '백엔드', '서울', '정규직', '협의', '2024-12-31', now(), 1),
       (2, '네이버', '데이터 분석가 채용', '카카오에서 데이터로 세상을 바꿔보세요!', '경력', '대학교 졸업', '백엔드', '부산', '정규직', '5000만원 이상', '2024-11-30',
        now(), 1),
       (3, '카카오', 'UI/UX 디자이너 채용', '라인에서 사용자 경험을 디자인하세요!', '신입', '대학교 졸업', '프론트엔드', '서울', '정규직', '3000만원 이상',
        '2024-10-31', now(), 1),
       (4, '토스', '마케팅 전문가 채용', '토스에서 함께 성장하세요!', '경력', '대학교 졸업', '백엔드', '부산', '정규직', '협의', '2024-09-30', now(), 1),
       (5, '라인', '운영 지원 인력 채용', '라인의 성장을 함께 이끌어가세요!', '신입', '고등학교 졸업', '프론트엔드', '부산', '정규직', '협의', '2024-09-11',
        now(), 1),
       (6, '배달의 민족', '운영 지원 인력 채용', '배달의민족의 성장을 함께 이끌어가세요!', '신입', '고등학교 졸업', '프론트엔드', '서울', '계약직', '협의', '2024-08-31',
        now(), 1),

       (7, '당근마켓', '소프트웨어 개발자 채용', '배달의민족의 성장을 함께 이끌어가세요!', '신입', '고등학교 졸업', '백엔드', '서울', '정규직', '5000만원 이상',
        '2024-10-12', now(), 1),
       (8, '하이브', '마케팅 전문가 채용', '배달의민족의 성장을 함께 이끌어가세요!', '경력', '고등학교 졸업', '프론트엔드', '서울', '계약직', '협의', '2024-05-20',
        now(), 1),
       (9, '겟인데어', 'UI/UX 디자이너 채용', '배달의민족의 성장을 함께 이끌어가세요!', '경력', '고등학교 졸업', '프론트엔드', '부산', '계약직', '3000만원 이상',
        '2024-06-22', now(), 1);
